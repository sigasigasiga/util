...
#define GRACE_FN_OP_LIFT_FUNCTION(...)                                                              \
...
#define GRACE_FN_OP_LIFT_MEMBER_SINGLE(MEMBER) \
    []< \
        typename T, \
        typename... Args, \
...
#define GRACE_FN_OP_MAKE_MEMBER_DETAIL_MANY(...) template __VA_ARGS__

#define GRACE_FN_OP_MAKE_MEMBER_NAME(FIRST, ...)                                                    \
    GRACE_FN_OP_MAKE_MEMBER_DETAIL##__VA_OPT__(_MANY)(FIRST __VA_OPT__(, ) __VA_ARGS__)

#define GRACE_FN_OP_LIFT_MEMBER(...)                                                                \
    GRACE_FN_OP_LIFT_MEMBER_SINGLE(GRACE_FN_OP_MAKE_MEMBER_NAME(__VA_ARGS__))
