...
auto impl(adl_tag, std::index_sequence<I>, Tup &&tup, Args &&...args)                            //
...
auto impl(adl_tag, std::index_sequence<I, Is...>, Tup &&tup, Args &&...args) //
...
auto tuple_fold_invoke(Tup &&tup, Args &&...args) //
